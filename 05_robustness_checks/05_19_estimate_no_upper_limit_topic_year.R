...
input_path <- "results/direct_outcome_gap/no_upper_limit_temporal_coordination_topic_year.parquet"
output_path <- "results/direct_outcome_gap/no_upper_limit_temporal_coordination_fe_results.csv"

if (!file.exists(input_path)) {
  stop(
    "No-upper-limit topic-year panel not found: ", input_path,
    ". Run build_no_upper_limit_topic_year_coordination.py first."
  )
}
