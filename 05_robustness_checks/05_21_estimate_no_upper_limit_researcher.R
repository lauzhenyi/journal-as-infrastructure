...
input_path <- "results/direct_outcome_gap/no_upper_limit_temporal_researcher_coordination.parquet"
output_path <- "results/direct_outcome_gap/no_upper_limit_temporal_researcher_coordination_fe_results.csv"

if (!file.exists(input_path)) {
  stop(
    "No-upper-limit researcher panel not found: ", input_path,
    ". Run build_no_upper_limit_researcher_coordination.py first."
  )
}
