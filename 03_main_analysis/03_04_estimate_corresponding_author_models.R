...
input_path <- "results/direct_outcome_gap/temporal_researcher_coordination.parquet"
output_path <- "results/direct_outcome_gap/temporal_researcher_coordination_fe_results.csv"
